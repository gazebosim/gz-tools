...
### Gazebo Tools 2.0.4 (2026-08-18)

1. Improve accuracy of colcon-test-result
    * [Pull request #172](https://github.com/gazebosim/gz-tools/pull/172)

1. fix: Add special handling for backward library path on windows
    * [Pull request #178](https://github.com/gazebosim/gz-tools/pull/178)

1. Compute relative library path for `backward` and remove macOS conditional
    * [Pull request #174](https://github.com/gazebosim/gz-tools/pull/174)

1. CI infrastructure:
    * [Pull request #182](https://github.com/gazebosim/gz-tools/pull/182)
    * [Pull request #169](https://github.com/gazebosim/gz-tools/pull/169)
...
1. Update maintainer email
    * [Pull request #149](https://github.com/gazebosim/gz-tools/pull/149)
